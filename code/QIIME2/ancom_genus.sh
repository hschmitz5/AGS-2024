#!/bin/bash
#SBATCH --job-name="ancom_genus"
#SBATCH --output=ancom_genus-%j.out
#SBATCH --error=ancom_genus-%j.err
#SBATCH -A p31629
#SBATCH -p normal
#SBATCH -t 24:00:00
#SBATCH -N 1
...
Rscript /gpfs/projects/b1052/hannah/r/scripts/run_ancombc2_genus.R
